...
//        5. 文件清理
    ...
    public ExecuteMessage compileFile(File userCodeFile) {
        ...
        try {
            ...
            ExecuteMessage executeMessage = ProcessUtils.runProcessAndGetMessages(compileProcess, "编译");
...
//            String runCmd = String.format("java -Xmx256m -Dfile.encoding=UTF-8 -cp %s Main %s", userCodeParentPath, inputArgs);
            ...
            try {
                ...
                ExecuteMessage executeMessage = ProcessUtils.runProcessAndGetMessages(runProcess, "运行");
